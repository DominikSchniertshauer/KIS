...
*/
	...
	open_create_dialog: function (){
		...
		*/
		...
		var description_label = new sap.ui.commons.Label({text: "Beschreibung: " , width: "205px"});
		...
		var interval_label = new sap.ui.commons.Label({text: "Verabreichungsinterval (Tage): " , width: "200px"});
		...
		*/
		...
		medication_temp_table.addColumn(  
			     new sap.ui.table.Column({  
			          label: new sap.ui.commons.Label({text: "Interval (Tage)"}),  
